...
void Runnable::geoip_lookup(Callback<> cb) {
    ...
    // TODO(bassosimone): add checks in engine.cpp to make sure that we
    // are passing the proper variables and add warnings regarding the
    // variables that have been removed from Measurement Kit.
